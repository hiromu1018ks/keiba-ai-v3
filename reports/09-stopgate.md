...
- 指標1 selected calibration (投票層 |mean_pred - frac_pos|):
  ...
  - speed_figure: 0.09055025022965757
  - improved: True
- 指標2 selected-only ROI/EV:
  - baseline: {'roi': 0.7017790428749333, 'n_selected': 5621, 'hit_rate': 0.09606831524639743}
  - speed_figure: {'roi': 0.8956459100368177, 'n_selected': 6247, 'hit_rate': 0.11077317112213862}
- 指標3 Brier/LogLoss/AUC 非劣化判定:
  - brier_delta: -0.00043736610495054284 (許容幅 +0.005)
  - logloss_delta: -0.001916424554023466 (許容幅 +0.02)
  - auc_delta: 0.005401761820183815 (許容幅 -0.005)
  - non_degraded: True
