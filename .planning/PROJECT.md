...
*Last updated: 2026-06-23 after Phase 6 complete (Evaluation & Calibration Gates — evaluator 拡張 + segment_eval 6軸 + is_primary migration + run_evaluation.py 統合 CLI・D-07 主モデル=LightGBM 確定・gate verdict WARN[SC#2 達成]・REVIEW HIGH#8 部分証明の正直記録・verification passed 12/12)*
